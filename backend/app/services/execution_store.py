...
from app.models.execution import ACTIVE_STATUSES, STATUS_QUEUED
...
def create_queued(db: Session, user_id: str = DEFAULT_USER_ID) -> Execution:
    """queued 상태의 실행 행을 만든다 (SR-F-701, 703)."""
    execution = Execution(
        id=new_ulid(),
